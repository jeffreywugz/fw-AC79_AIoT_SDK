...
#if CONFIG_BLE_MESH_ENABLE && (CONFIG_MESH_MODEL == SIG_MESH_ALIGENIE_LIGHT)
                                ...
                                struct net_buf_simple *buf)
{
    ...
    if (onoff_state->current == 1) {
        printf("onoff set lightness = %d", light.lightness_default);
                                ...
                                struct net_buf_simple *buf)
{
    ...
    printf("light set to %d", lightness);
