...
static void bt_music_test_init(void *priv)
{
    bt_ble_module_init();
}
static int bt_music_test_task_init(void)
{
    puts("bt_music_test_task_init \n\n");
    return thread_fork("bt_music_test_init", 11, 1024, 0, 0, bt_music_test_init, NULL);
}
late_initcall(bt_music_test_task_init);
