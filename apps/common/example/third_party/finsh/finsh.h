...
#define rt_uint16_t u16
#define rt_uint16_t u16
#define rt_uint32_t u32
typedef int  rt_bool_t;
typedef int  rt_err_t;
typedef unsigned long rt_ubase_t, rt_size_t;
#define rt_inline __attribute__((always_inline))
