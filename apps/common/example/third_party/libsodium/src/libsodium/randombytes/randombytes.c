...
#ifdef  RANDOMBYTES_USER_DEFAULT //采用用户自定义随机数发生器
SODIUM_EXPORT
extern const struct randombytes_implementation randombytes_JL_implementation;
#undef RANDOMBYTES_DEFAULT_IMPLEMENTATION
#define RANDOMBYTES_DEFAULT_IMPLEMENTATION &randombytes_JL_implementation
#else
# include "randombytes_sysrandom.h"
#endif
