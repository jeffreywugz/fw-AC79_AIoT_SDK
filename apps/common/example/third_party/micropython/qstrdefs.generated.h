...
QDEF(MP_QSTR__brace_open__colon__hash_o_brace_close_, (const byte *)"\xdb\x27" "_brace_open__colon__hash_o_brace_close_")
QDEF(MP_QSTR__brace_open__colon__hash_x_brace_close_, (const byte *)"\x2c\x27" "_brace_open__colon__hash_x_brace_close_")
