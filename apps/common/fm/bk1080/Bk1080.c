...
#if TCFG_FM_BK1080_ENABLE && CONFIG_FM_DEV_ENABLE
...
static void BEKEN_I2c_Read(u8 reg, u8 *pBuf, u8 num)
{
    reg = reg << 1;
    reg |= 0x01;
    fm_IIC_readn(CHIP_DEV_ID, reg, pBuf, num);
}
...
{
    reg = reg << 1;
    fm_IIC_write(CHIP_DEV_ID, reg, pBuf, num);
}
...
*/
/*----------------------------------------------------------------------------*/
static int bk1080_init(void *priv)
{
    u8 temp[2];
...
*/
/*----------------------------------------------------------------------------*/
static void bk1080_setfreq(u16 curFreq)
{
    u8 curChan;
    u16 temp;
...
*/
/*----------------------------------------------------------------------------*/
static bool bk1080_set_fre(void *priv, u16 freq)
{
...
*/
/*----------------------------------------------------------------------------*/
static int bk1080_powerdown(void *priv)
{
    u16 temp = 0x4102;
...
*/
/*----------------------------------------------------------------------------*/
static void bk1080_mute(void *priv, u8 flag)
{
    u8 TmpData8[2];
...
*/
/*----------------------------------------------------------------------------*/
static bool bk1080_read_id(void *priv)
{
    u16 bk_id = 0;
