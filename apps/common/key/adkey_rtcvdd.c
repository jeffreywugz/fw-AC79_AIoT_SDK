...
static u16 ad_rtcvdd_key_table[ADC_KEY_NUMBER + 1] = {0};

#define FULL_AD_VOLTAGE 	0x3FFF

static volatile u8 adkey_lock_cnt = 0;
static u8 rtcvdd_cnt = 10;
static u8 rtcvdd_full_cnt = 0xff;
static u16 rtcvdd_full_value = FULL_AD_VOLTAGE;
static u16 max_value = 0;
static u16 min_value = 0xffff;
static u32 total_value = 0;
