...
/*extern int ui_touch_msg_post(struct ui_touch_event *event);*/
/*extern int ui_touch_msg_post_withcallback(struct ui_touch_event *event, void (*cb)(u8 finish));*/
...
extern void ui_set_touch_event(int (*touch_event)(void), int interval);
