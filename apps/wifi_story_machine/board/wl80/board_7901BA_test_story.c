...
static const struct iokey_port iokey_list[] = {
    {
        ...
        .key_type.one_io.port = IO_PORTC_09,    //IO按键对应的引脚
        .key_value = KEY_VOLUME_DEC,            //按键值
    },
    {
        .connect_way = ONE_PORT_TO_LOW,
        .key_type.one_io.port = IO_PORTC_10,
...
#ifdef CONFIG_UI_ENABLE
//注意 开UI宏 需要检查于SD卡复用的情况 SD卡不能用D口 建议使用A口
...
static const struct camera_platform_data camera0_data = {
    .xclk_gpio      = IO_PORTC_06,//注意： 如果硬件xclk接到芯片IO，则会占用OUTPUT_CHANNEL1
    .reset_gpio     = -1,
    .online_detect  = NULL,
    .pwdn_gpio      = -1,
    .power_value    = 0,
...
static void board_power_init(void)
{
    ...
    gpio_direction_output(IO_PORTC_07, 1);//打开VDDIO_CTL
}
...
void board_init()
{
    ...
    cfg_file_parse();
#endif
#ifndef CONFIG_APP_MUSIC_ENABLE
