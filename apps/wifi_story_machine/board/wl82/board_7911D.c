...
static const struct iokey_port iokey_list[] = {
    {
        ...
        .key_type.one_io.port = IO_PORTH_00,    //IO按键对应的引脚
        .key_value = KEY_UP,                    //按键值
    },
    {
        .connect_way = ONE_PORT_TO_LOW,
        .key_type.one_io.port = IO_PORTH_01,
        .key_value = KEY_DOWN,                  //按键值
    },
    {
        .connect_way = ONE_PORT_TO_LOW,
        .key_type.one_io.port = IO_PORTH_02,
...
PWM_PLATFORM_DATA_BEGIN(pwm_data1)
    .port   = IO_PORTH_02,//选择定时器的TIMER PWM任意IO，pwm_ch加上PWM_TIMER3_OPCH3或PWM_TIMER2_OPCH2有效,只支持2个PWM,占用output_channel2/3，其他外设使用output_channel需留意
...
static const struct pap_info pap_data = {
    ...
    .port_sel		= PAP_PORT_B,			//PAP_PORT_A PAP_PORT_B
