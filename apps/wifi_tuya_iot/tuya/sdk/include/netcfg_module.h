 ...
 *
 * @param[in] netcfg_policy netcfg methods,such as WF_START_AP_ONLY, WF_START_SMART_ONLY, WF_START_AP_FIRST,WF_START_SMART_FIRST,WF_START_SMART_AP_CONCURRENT
