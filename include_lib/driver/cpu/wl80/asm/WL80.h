...
typedef struct {
    ...
    ___RW ___u32(VACT);
    ___RW ___u32(HACT);
    ___RW ___u32(FRC_CFG);
    ___RW ___u32(DMA_CNT);
    ___RW ___u32(DMA_BASE0);
    ___RW ___u32(DMA_BASE1);
    ___RW ___u32(DMA_BASE2);
    ___RW ___u32(SCN_CON);
    ___RW ___u32(OSD_CON);
    ___RW ___u32(OSD_BASE);
    ___RW ___u32(OSD_HCFG);
    ___RW ___u32(OSD_VCFG);
    ___RW ___u32(OSD_COLOR);
} JL_ISC_TypeDef;

#define JL_ISC_BASE                   (hsfr_base + map_adr(0x1a, 0x00))
#define JL_ISC                        ((JL_ISC_TypeDef  *)JL_ISC_BASE)
...
#define JL_DBG_BASE                   (hsfr_base + map_adr(0x1b, 0x00))
...
#define JL_USB1_IO                      ((JL_USB_IO_TypeDef    *)(JL_USB_IO_BASE + 8))
...
#define JL_EMI_BASE                     (lsfr_base + map_adr(0x29, 0x00))
...
typedef struct {
    ...
    ___RW ___s16(DAC_DTV);
    ___RW ___s16(DAC_DTB);
...
typedef struct {
    ...
    ___RW ___u32(GLB_GAINL);
    ___RW ___u32(GLB_GAINR);
