...
extern void osd_close(void *isc);
extern int osd_buff_update(void *isc, char id);
extern void osd_init(void *isc);
extern void osd_en(void *isc, u8 enable);
extern int osd_attr_set(void *isc, struct video_osd_attr *osd_attr);
extern int osd_attr_get(void *isc, struct video_osd_attr *osd_attr);
extern int osd_set_src_width_height(void *isc, u16 w, u16 h);
