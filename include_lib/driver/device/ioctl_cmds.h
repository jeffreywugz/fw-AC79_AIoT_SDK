...
#define IOCTL_GET_WRITE_PROTECT_VALUE   47
...
#define IOCTL_SET_VM_INFO               205
#define IOCTL_GET_VM_INFO               206

#define IOCTL_SET_DATA_CALLBACK         301
#define IOCTL_GET_PART_INFO             320

#define IOCTL_SET_DIRECT_MIC_TO_DAC     400
#define IOCTL_SET_DIRECT_LINEIN_TO_DAC  401
#define IOCTL_GET_UNIQUE_ID             402
#define IOCTL_ERASE_OTP                 403
#define IOCTL_WRITE_OTP                 404
#define IOCTL_READ_OTP                  405
#define IOCTL_CLR_WRITE_MODE            406
#define IOCTL_GET_HEAD_INFO             407
#define IOCTL_REFRESH_VAD               408
