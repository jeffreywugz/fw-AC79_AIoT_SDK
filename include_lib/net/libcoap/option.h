...
{
    return bits_setb((unsigned char *)filter, sizeof(coap_opt_filter_t), type);
}
...
{
    return bits_clrb((unsigned char *)filter, sizeof(coap_opt_filter_t), type);
}
...
{
    return bits_getb((unsigned char *)filter, sizeof(coap_opt_filter_t), type);
}
