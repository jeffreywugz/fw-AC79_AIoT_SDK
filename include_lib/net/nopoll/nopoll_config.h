...
/**
 * @brief Indicates that this platform have support for LWIP.
 */
#define NOPOLL_LWIP_ENABLED (1)

/**
 * @brief Indicates that this platform have support for LWIP IPV6.
 */
//#define NOPOLL_LWIP_IPV6 (1)
...
/**
 * @brief Indicates that this platform have support for MBEDTLS.
 */
#define NOPOLL_MBEDTLS_ENABLED (1)
