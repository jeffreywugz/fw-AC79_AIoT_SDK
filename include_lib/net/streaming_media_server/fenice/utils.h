/* *
 *  $Id: utils.h 391 2006-09-27 13:43:01Z shawill $
 *
...
#define SD_FILE_EXT_NAME "FILE_EXT_NAME"
...
#define SD_MULTICAST_PORT "MULTICAST_PORT"
#define SCREEN_WIDE "SCREEN_WIDTH"
#define SCREEN_HIGH "SCREEN_HIGHT"
...
#endif
#define lround(x) (x)//(x - 	floor(x) < 0.5) ? floor(x): ceil(x)
