...
#define CPU_SW_EXCEPTION(x) do{printf("FAT CPU_SW_EXCEPTION --- %s,%d \r\n",__FUNCTION__,__LINE__);}while(0)
...
typedef  CPU_INT32U  CLK_TS_SEC, CLK_TZ_SEC;
...
extern int Clk_GetDateTime(CLK_DATE_TIME *);
extern int Clk_IsDateTimeValid(CLK_DATE_TIME *);
extern int Clk_UnixDateTimeMake(CLK_DATE_TIME *, int, int, int, int, int, int, int);
extern int Clk_DateTimeToTS_Unix(CLK_TS_SEC *, CLK_DATE_TIME *);
extern int Clk_TS_UnixToDateTime(CLK_TS_SEC, CLK_TZ_SEC, CLK_DATE_TIME *);
extern int Clk_IsUnixDateTimeValid(CLK_DATE_TIME *);
extern int Clk_SetDateTime(CLK_DATE_TIME *);
extern int Clk_DateTimeToStr(CLK_DATE_TIME *, char *, char *, char *);
