...
#define RT_THREAD_PRIORITY_MAX 30
...
typedef s16			                    rt_int16_t;     /**< 16bit integer type */
typedef s32                             rt_int32_t;     /**< 32bit integer type */
typedef u8                              rt_uint8_t;     /**<  8bit unsigned integer type */
typedef u16                             rt_uint16_t;    /**< 16bit unsigned integer type */
typedef u32                             rt_uint32_t;    /**< 32bit unsigned integer type */
#endif
...
#define RT_SECTION(x)               __attribute__((section(#x),used))
#define RT_UNUSED                   __attribute__((unused))
#define RT_USED                     __attribute__((used))
#define ALIGN(n)                    __attribute__((aligned(n)))
#define RT_WEAK                     __attribute__((weak))
