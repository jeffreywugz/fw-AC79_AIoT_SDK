...
char PRODUCT_KEY[IOTX_PRODUCT_KEY_LEN + 1] = "a1YGQti1kxb";
char DEVICE_NAME[IOTX_DEVICE_NAME_LEN + 1] = "iot-001";
char DEVICE_SECRET[IOTX_DEVICE_SECRET_LEN + 1] = "f813d4a3d62b1eb8eea2b6652025f81a";
char PRODUCT_SECRET[IOTX_PRODUCT_SECRET_LEN + 1] = "a1YGQti1kxb";
...
static void linkkit_start(void *priv)
{
    linkkit_main();
}

int linkkit_task(void)
{
    if (thread_fork("linkkit_start", 17, 2024, 0, 0, linkkit_start, NULL) != OS_NO_ERR) {
        return -1;
    }
    return 0;
}
