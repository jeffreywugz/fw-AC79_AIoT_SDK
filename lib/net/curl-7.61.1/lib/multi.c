...
#endif // USE_RTOS
{
    ...
    *running_handles = multi->num_alive;
    ...
    infof(0, "Rerturn %s, return code : %d\n", __func__, returncode);
    return returncode;
}
...
#endif //   USE_RTOS
{
    ...
    *msgs_in_queue = 0; /* default to none */
    ...
    if (GOOD_MULTI_HANDLE(multi) &&
        ...
        msg = e->ptr;
        infof(0, "msg : %d\n", msg->extmsg.msg);
        infof(0, "easyhandle : %p\n", msg->extmsg.easy_handle);
        infof(0, "result : %d\n", msg->extmsg.data.result);
