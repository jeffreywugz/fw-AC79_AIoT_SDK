...
#else
CURL_EXTERN CURLSHcode curl_share_setopt(CURLSH *curl_share, CURLSHoption option, ...)
#endif
{
#ifdef USE_RTOS
    struct Curl_share *share = (struct Curl_share *) curl_share;
#endif // USE_RTOS
    va_list param;
    int type;
...
#else
CURL_EXTERN CURLSHcode curl_share_cleanup(CURLSH *curl_share)
#endif
{
#ifdef USE_RTOS
    struct Curl_share *share = (struct Curl_share *) curl_share;
