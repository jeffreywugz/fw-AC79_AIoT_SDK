...
struct protocol {
    ...
    int (*iperf_listen)(struct iperf_test *);
    int (*iperf_connect)(struct iperf_test *);
    int (*iperf_send)(struct iperf_stream *);
    int (*iperf_recv)(struct iperf_stream *);
    int (*iperf_init)(struct iperf_test *);
