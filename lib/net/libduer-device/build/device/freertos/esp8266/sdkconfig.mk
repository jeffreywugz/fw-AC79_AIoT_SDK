...
COMPILER := xtensa-lx106

TOOLCHAIN ?= xtensa-lx106-elf-

ifeq ($(strip $(SDK_PATH)),)
$(error please config the environment variable SDK_PATH \
        which point to the ESP8266 SDK root directory)
endif

CFLAGS := -Wall -g -Os -mlongcalls -ffunction-sections -fdata-sections -std=c99

COM_DEFS := DUER_PLATFORM_ESP8266 __TARGET_TRACKER__
