...
ifeq ($(strip $(MIPS_SYSROOT_PATH)),)
$(error please config the environment variable MIPS_SYSROOT_PATH \
        which point to the sysroot of the cross-compiler)
endif

CFLAGS += --sysroot=$(MIPS_SYSROOT_PATH)
LDFLAGS += --sysroot=$(MIPS_SYSROOT_PATH)
