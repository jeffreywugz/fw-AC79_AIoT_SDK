...
void duer_txt2tts()
{
    ...
    baidu_json_AddStringToObject(data, "txt", "hello world");
    baidu_json_AddNumberToObject(log, "id", 123);
    baidu_json_AddItemToObject(log, "data", (baidu_json *)data);
    baidu_json_AddStringToObject(log, "extra", "liulili");
    baidu_json_AddItemToObject(speech, "duer_speech", (baidu_json *)log);
