...
int duer_report_static_system_info(void)
{
    ...
    baidu_json_AddStringToObject(system_info, "OS_Version", (char *)info.os_version);
    baidu_json_AddStringToObject(system_info, "Duer_OS_Version", (char *)info.duer_os_version);
    baidu_json_AddStringToObject(system_info, "Software_Version", (char *)info.sdk_version);
    baidu_json_AddStringToObject(system_info, "Brand", (char *)info.brand);
    baidu_json_AddStringToObject(system_info, "Equipment_type", (char *)info.equipment_type);
    baidu_json_AddStringToObject(system_info, "Hardware_Version", (char *)info.hardware_version);
    baidu_json_AddNumberToObject(system_info, "RAM_Size", info.ram_size);
    baidu_json_AddNumberToObject(system_info, "ROM_Size", info.rom_size);
    baidu_json_AddItemToObject(data, "System_Static_Info", system_info);
