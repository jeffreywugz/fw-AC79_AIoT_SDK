...
int duer_ota_uninit_installer(void)
{
    int ret = DUER_OK;
    duer_ota_installer_t *installer_obj = s_installer_list_head;
    ...
    s_installer_list_head = NULL;

    if (s_lock_ota_installer) {
        duer_mutex_destroy(s_lock_ota_installer);
        s_lock_ota_installer = NULL;
    }
