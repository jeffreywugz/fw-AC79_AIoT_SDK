 ...
 * Desc: Adapt internal to LPT230 VER1.0
...
extern duer_status_t bcasoc_send(duer_socket_t ctx, const void *data, duer_size_t size,
                                 const duer_addr_t *addr);

extern duer_status_t bcasoc_recv(duer_socket_t ctx, void *data, duer_size_t size,
                                 duer_addr_t *addr);

extern duer_status_t bcasoc_recv_timeout(duer_socket_t ctx, void *data, duer_size_t size,
...
extern void bcadbg(duer_context ctx, duer_u32_t level, const char *file, duer_u32_t line,
                   const char *msg);
