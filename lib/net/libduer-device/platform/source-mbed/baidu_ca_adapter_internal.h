...
extern duer_socket_t bcasoc_create(duer_transevt_func func);
...
extern duer_mutex_t bcamutex_create(void);

extern duer_status_t bcamutex_lock(duer_mutex_t mutex);

extern duer_status_t bcamutex_unlock(duer_mutex_t mutex);

extern duer_status_t bcamutex_destroy(duer_mutex_t mutex);
