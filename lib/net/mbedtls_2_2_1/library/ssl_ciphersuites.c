...
#if defined(MBEDTLS_CIPHER_MODE_CBC)
#if defined(MBEDTLS_CIPHER_TLS_RSA_WITH_AES_128_CBC_SHA256)
    {
...
#endif
#if defined(MBEDTLS_CIPHER_TLS_RSA_WITH_AES_256_CBC_SHA256)
    {
...
#if defined(MBEDTLS_SHA1_C)
#if defined(MBEDTLS_CIPHER_MODE_CBC)
#if defined(MBEDTLS_CIPHER_TLS_RSA_WITH_AES_128_CBC_SHA)
    {
...
#endif
#if defined(MBEDTLS_CIPHER_TLS_RSA_WITH_AES_256_CBC_SHA)
    {
...
#endif
            {
                printf("*****************mbedtls_ssl_list_ciphersuites = %s\n", cs_info->name);
                *(q++) = *p;
            }
        }
        *q = 0;
