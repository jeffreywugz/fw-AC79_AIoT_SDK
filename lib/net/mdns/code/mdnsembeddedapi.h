#ifndef __MDNSENBEDDE_API_H
#define __MDNSENBEDDE_API_H
...
extern SearchListElem *mDNS_SearchList;		// This really ought to be part of mDNS_struct -- SC
...
#define _PLATFORM_HAS_STRONG_PRNG_ 1	//modify
...
struct CompileTimeAssertionChecks_mDNS {
    ...
    char assertF[(sizeof(EthernetHeader)   ==   14) ? 1 : 0];
    char assertG[(sizeof(ARP_EthIP)   ==   28) ? 1 : 0];
