...
void IOT_OTA_Fetched(void *handle)
{
...
void IOT_OTA_InitTimer(void *handle)
{
    OTA_Struct_t *h_ota = (OTA_Struct_t *)handle;
...
void IOT_OTA_CountTimer(void *handle)
{
    OTA_Struct_t *h_ota = (OTA_Struct_t *)handle;
    countdown(&h_ota->report_timer, 1);
...
char IOT_OTA_Expired(void *handle)
{
    OTA_Struct_t *h_ota = (OTA_Struct_t *)handle;
    return expired(&h_ota->report_timer);
}

char *IOT_OTA_GetUrl(void *handle)
{
    OTA_Struct_t *h_ota = (OTA_Struct_t *)handle;
    return h_ota->purl;
}
