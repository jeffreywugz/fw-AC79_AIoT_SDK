                     ...
                     HTTPc_ERR       *p_err)
{
    ...
    /* DEF_NULL, */
    /* &err_rtos); */
    KAL_TaskCreate(HTTPc_TASK_NAME,
                   HTTPcTask,
                   DEF_NULL,
                   p_task_cfg->Prio,
                                        ...
                                        HTTPc_ERR   *p_err)
{
    ...
    /* &err_rtos); */
    /********************************修改***********************************************/
    KAL_SemCreate(p_conn->ConnectSignal,
                  &err_rtos);
                                      ...
                                      HTTPc_ERR   *p_err)
{
    ...
    /********************************修改***********************************************/
    KAL_SemCreate(p_conn->CloseSignal,
                  &err_rtos);
    err_rtos = RTOS_ERR_NONE;
    /********************************修改***********************************************/
    if (err_rtos != RTOS_ERR_NONE) {
                                      ...
                                      HTTPc_ERR   *p_err)
{
    ...
    /********************************修改***********************************************/
    KAL_SemCreate(p_conn->TransDoneSignal,
                  &err_rtos);
    err_rtos = RTOS_ERR_NONE;
    /********************************修改***********************************************/
    if (err_rtos != RTOS_ERR_NONE) {
