    ...
    do {
        ...
        /* when start is "\r\n" */
            ...
            *end = 0; /* null terminate */
            ...
            case phr_have_type:
                if (XSTRLEN(start) < 13) {
                    /* 13 is the shortest of the following
                               ...
                               const char *exHdrs, byte *buf, int bufSize)
{
    ...
    if (contentTypeLen > 0) {
        ...
        bufSize -= contentTypeStrLen;
        XSTRNCPY((char *)buf, contentType, bufSize);
        buf += contentTypeLen;
        bufSize -= contentTypeLen;
    }
    if (exHdrsLen > 0) {
