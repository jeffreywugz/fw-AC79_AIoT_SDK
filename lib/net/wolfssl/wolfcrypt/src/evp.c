...
int wolfSSL_EVP_PKEY_bits(const WOLFSSL_EVP_PKEY *pkey)
{
    ...
    if ((bytes = wolfSSL_EVP_PKEY_size((WOLFSSL_EVP_PKEY *)pkey)) == 0) {
        return 0;
    }
    return bytes * 8;
}
