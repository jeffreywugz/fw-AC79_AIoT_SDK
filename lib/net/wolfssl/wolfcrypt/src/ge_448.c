...
void sc448_reduce(uint8_t *b)
{
    ...
    c = t[ 4] >> 56;
    t[ 5] += c;
    t[ 4] = t[ 4] & 0xffffffffffffff;
    c = t[ 5] >> 56;
    t[ 6] += c;
    t[ 5] = t[ 5] & 0xffffffffffffff;
    c = t[ 6] >> 56;
    t[ 7] += c;
    t[ 6] = t[ 6] & 0xffffffffffffff;
    c = t[ 7] >> 56;
    t[ 8] += c;
    t[ 7] = t[ 7] & 0xffffffffffffff;
    c = t[ 8] >> 56;
    t[ 9] += c;
    t[ 8] = t[ 8] & 0xffffffffffffff;
    c = t[ 9] >> 56;
    t[10] += c;
    t[ 9] = t[ 9] & 0xffffffffffffff;
    c = t[10] >> 56;
    t[11] += c;
    t[10] = t[10] & 0xffffffffffffff;
    c = t[11] >> 56;
    t[12] += c;
    t[11] = t[11] & 0xffffffffffffff;
    ...
    c = t[ 0] >> 56;
    t[ 1] += c;
    t[ 0] = t[ 0] & 0xffffffffffffff;
    c = t[ 1] >> 56;
    t[ 2] += c;
    t[ 1] = t[ 1] & 0xffffffffffffff;
    c = t[ 2] >> 56;
    t[ 3] += c;
    t[ 2] = t[ 2] & 0xffffffffffffff;
    c = t[ 3] >> 56;
    t[ 4] += c;
    t[ 3] = t[ 3] & 0xffffffffffffff;
    c = t[ 4] >> 56;
    t[ 5] += c;
    t[ 4] = t[ 4] & 0xffffffffffffff;
    c = t[ 5] >> 56;
    ...
    c = t[ 0] >> 56;
    t[ 1] += c;
    d[ 0] = (int64_t)(t[ 0] & 0xffffffffffffff);
    c = t[ 1] >> 56;
    t[ 2] += c;
    d[ 1] = (int64_t)(t[ 1] & 0xffffffffffffff);
    c = t[ 2] >> 56;
    t[ 3] += c;
    d[ 2] = (int64_t)(t[ 2] & 0xffffffffffffff);
    c = t[ 3] >> 56;
    t[ 4] += c;
    d[ 3] = (int64_t)(t[ 3] & 0xffffffffffffff);
    c = t[ 4] >> 56;
    t[ 5] += c;
    d[ 4] = (int64_t)(t[ 4] & 0xffffffffffffff);
    c = t[ 5] >> 56;
    t[ 6] += c;
    d[ 5] = (int64_t)(t[ 5] & 0xffffffffffffff);
    c = t[ 6] >> 56;
    t[ 7] += c;
    d[ 6] = (int64_t)(t[ 6] & 0xffffffffffffff);
    d[ 7] = t[7];
    /* Mod bits over 56 in last word */
    o = d[7] >> 54;
    d[ 7] &= 0x3fffffffffffff;
    ...
    o = d[ 0] >> 56;
    d[ 1] += o;
    d[ 0] = d[ 0] & 0xffffffffffffff;
    o = d[ 1] >> 56;
    d[ 2] += o;
    d[ 1] = d[ 1] & 0xffffffffffffff;
    o = d[ 2] >> 56;
    d[ 3] += o;
    d[ 2] = d[ 2] & 0xffffffffffffff;
    o = d[ 3] >> 56;
    d[ 4] += o;
    d[ 3] = d[ 3] & 0xffffffffffffff;
    o = d[ 4] >> 56;
    d[ 5] += o;
    d[ 4] = d[ 4] & 0xffffffffffffff;
    o = d[ 5] >> 56;
    d[ 6] += o;
    d[ 5] = d[ 5] & 0xffffffffffffff;
    o = d[ 6] >> 56;
    d[ 7] += o;
    d[ 6] = d[ 6] & 0xffffffffffffff;
                  ...
                  const uint8_t *d)
{
    ...
    c = t[12] >> 56;
    t[13] += c;
    t[12] = t[12] & 0xffffffffffffff;
    c = t[13] >> 56;
    t[14] += c;
    t[13] = t[13] & 0xffffffffffffff;
    c = t[14] >> 56;
    t[15] += c;
    t[14] = t[14] & 0xffffffffffffff;
    /* Mod top half of extra words */
    t[ 4] += (int128_t)0x21cf5b5529eec34L * t[12];
    t[ 5] += (int128_t)0x0f635c8e9c2ab70L * t[12];
    t[ 6] += (int128_t)0x2d944a725bf7a4cL * t[12];
    ...
    c = t[ 0] >> 56;
    t[ 1] += c;
    rd[ 0] = (int64_t)(t[ 0] & 0xffffffffffffff);
    c = t[ 1] >> 56;
    t[ 2] += c;
    rd[ 1] = (int64_t)(t[ 1] & 0xffffffffffffff);
    c = t[ 2] >> 56;
    t[ 3] += c;
    rd[ 2] = (int64_t)(t[ 2] & 0xffffffffffffff);
    c = t[ 3] >> 56;
    t[ 4] += c;
    rd[ 3] = (int64_t)(t[ 3] & 0xffffffffffffff);
    c = t[ 4] >> 56;
    t[ 5] += c;
    rd[ 4] = (int64_t)(t[ 4] & 0xffffffffffffff);
    c = t[ 5] >> 56;
    t[ 6] += c;
    rd[ 5] = (int64_t)(t[ 5] & 0xffffffffffffff);
    c = t[ 6] >> 56;
    t[ 7] += c;
    rd[ 6] = (int64_t)(t[ 6] & 0xffffffffffffff);
    rd[ 7] = t[7];
    /* Mod bits over 56 in last word */
    o = rd[7] >> 54;
    rd[ 7] &= 0x3fffffffffffff;
    ...
    o = rd[ 0] >> 56;
    rd[ 1] += o;
    rd[ 0] = rd[ 0] & 0xffffffffffffff;
    o = rd[ 1] >> 56;
    rd[ 2] += o;
    rd[ 1] = rd[ 1] & 0xffffffffffffff;
    o = rd[ 2] >> 56;
    rd[ 3] += o;
    rd[ 2] = rd[ 2] & 0xffffffffffffff;
    o = rd[ 3] >> 56;
    rd[ 4] += o;
    rd[ 3] = rd[ 3] & 0xffffffffffffff;
    o = rd[ 4] >> 56;
    rd[ 5] += o;
    rd[ 4] = rd[ 4] & 0xffffffffffffff;
    o = rd[ 5] >> 56;
    rd[ 6] += o;
    rd[ 5] = rd[ 5] & 0xffffffffffffff;
    o = rd[ 6] >> 56;
    rd[ 7] += o;
    rd[ 6] = rd[ 6] & 0xffffffffffffff;
...
void sc448_reduce(uint8_t *b)
{
    ...
    c = t[ 0] >> 28;
    t[ 1] += c;
    d[ 0] = (int32_t)(t[ 0] & 0xfffffff);
    c = t[ 1] >> 28;
    t[ 2] += c;
    d[ 1] = (int32_t)(t[ 1] & 0xfffffff);
    c = t[ 2] >> 28;
    t[ 3] += c;
    d[ 2] = (int32_t)(t[ 2] & 0xfffffff);
    c = t[ 3] >> 28;
    t[ 4] += c;
    d[ 3] = (int32_t)(t[ 3] & 0xfffffff);
    c = t[ 4] >> 28;
    t[ 5] += c;
    d[ 4] = (int32_t)(t[ 4] & 0xfffffff);
    c = t[ 5] >> 28;
    t[ 6] += c;
    d[ 5] = (int32_t)(t[ 5] & 0xfffffff);
    c = t[ 6] >> 28;
    t[ 7] += c;
    d[ 6] = (int32_t)(t[ 6] & 0xfffffff);
    c = t[ 7] >> 28;
    t[ 8] += c;
    d[ 7] = (int32_t)(t[ 7] & 0xfffffff);
    c = t[ 8] >> 28;
    t[ 9] += c;
    d[ 8] = (int32_t)(t[ 8] & 0xfffffff);
    c = t[ 9] >> 28;
    t[10] += c;
    d[ 9] = (int32_t)(t[ 9] & 0xfffffff);
    c = t[10] >> 28;
    t[11] += c;
    d[10] = (int32_t)(t[10] & 0xfffffff);
    c = t[11] >> 28;
    t[12] += c;
    d[11] = (int32_t)(t[11] & 0xfffffff);
    c = t[12] >> 28;
    t[13] += c;
    d[12] = (int32_t)(t[12] & 0xfffffff);
    c = t[13] >> 28;
    t[14] += c;
    d[13] = (int32_t)(t[13] & 0xfffffff);
    c = t[14] >> 28;
    t[15] += c;
    d[14] = (int32_t)(t[14] & 0xfffffff);
    d[15] = t[15];
                  ...
                  const uint8_t *d)
{
    ...
    c = t[ 0] >> 28;
    t[ 1] += c;
    rd[ 0] = (int32_t)(t[ 0] & 0xfffffff);
    c = t[ 1] >> 28;
    t[ 2] += c;
    rd[ 1] = (int32_t)(t[ 1] & 0xfffffff);
    c = t[ 2] >> 28;
    t[ 3] += c;
    rd[ 2] = (int32_t)(t[ 2] & 0xfffffff);
    c = t[ 3] >> 28;
    t[ 4] += c;
    rd[ 3] = (int32_t)(t[ 3] & 0xfffffff);
    c = t[ 4] >> 28;
    t[ 5] += c;
    rd[ 4] = (int32_t)(t[ 4] & 0xfffffff);
    c = t[ 5] >> 28;
    t[ 6] += c;
    rd[ 5] = (int32_t)(t[ 5] & 0xfffffff);
    c = t[ 6] >> 28;
    t[ 7] += c;
    rd[ 6] = (int32_t)(t[ 6] & 0xfffffff);
    c = t[ 7] >> 28;
    t[ 8] += c;
    rd[ 7] = (int32_t)(t[ 7] & 0xfffffff);
    c = t[ 8] >> 28;
    t[ 9] += c;
    rd[ 8] = (int32_t)(t[ 8] & 0xfffffff);
    c = t[ 9] >> 28;
    t[10] += c;
    rd[ 9] = (int32_t)(t[ 9] & 0xfffffff);
    c = t[10] >> 28;
    t[11] += c;
    rd[10] = (int32_t)(t[10] & 0xfffffff);
    c = t[11] >> 28;
    t[12] += c;
    rd[11] = (int32_t)(t[11] & 0xfffffff);
    c = t[12] >> 28;
    t[13] += c;
    rd[12] = (int32_t)(t[12] & 0xfffffff);
    c = t[13] >> 28;
    t[14] += c;
    rd[13] = (int32_t)(t[13] & 0xfffffff);
    c = t[14] >> 28;
    t[15] += c;
    rd[14] = (int32_t)(t[14] & 0xfffffff);
    rd[15] = t[15];
    /* Mod bits over 28 in last word */
    o = rd[15] >> 26;
    rd[15] &= 0x3ffffff;
    ...
    o = rd[10] >> 28;
    rd[11] += o;
    rd[10] = rd[10] & 0xfffffff;
    o = rd[11] >> 28;
    rd[12] += o;
    rd[11] = rd[11] & 0xfffffff;
    o = rd[12] >> 28;
    rd[13] += o;
    rd[12] = rd[12] & 0xfffffff;
    o = rd[13] >> 28;
    rd[14] += o;
    rd[13] = rd[13] & 0xfffffff;
    o = rd[14] >> 28;
    rd[15] += o;
    rd[14] = rd[14] & 0xfffffff;
