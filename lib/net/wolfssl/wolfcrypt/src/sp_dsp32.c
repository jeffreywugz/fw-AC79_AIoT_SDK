...
#else
    a[1] += a[0] >> 26;
    a[0] = Q6_R_and_RR(a[0], 0x3ffffff);
    a[2] += a[1] >> 26;
    a[1] = Q6_R_and_RR(a[1], 0x3ffffff);
    a[3] += a[2] >> 26;
    a[2] = Q6_R_and_RR(a[2], 0x3ffffff);
    a[4] += a[3] >> 26;
    a[3] = Q6_R_and_RR(a[3], 0x3ffffff);
    a[5] += a[4] >> 26;
    a[4] = Q6_R_and_RR(a[4], 0x3ffffff);
    a[6] += a[5] >> 26;
    a[5] = Q6_R_and_RR(a[5], 0x3ffffff);
    a[7] += a[6] >> 26;
    a[6] = Q6_R_and_RR(a[6], 0x3ffffff);
    a[8] += a[7] >> 26;
    a[7] = Q6_R_and_RR(a[7], 0x3ffffff);
    a[9] += a[8] >> 26;
    a[8] = Q6_R_and_RR(a[8], 0x3ffffff);
#endif
}
...
static void sp_256_mont_shift_10(sp_digit *r, const sp_digit *a)
{
    ...
    n = a[9] >> 22;
    n += (s & 0x3ffffff) << 4;
    r[ 0] = Q6_R_and_RR(n, 0x3ffffff);
    n >>= 26;
    s = a[11] + (s >> 26);
    n += (s & 0x3ffffff) << 4;
    r[ 1] = Q6_R_and_RR(n, 0x3ffffff);
    n >>= 26;
    s = a[12] + (s >> 26);
    n += (s & 0x3ffffff) << 4;
    r[ 2] = Q6_R_and_RR(n, 0x3ffffff);
    n >>= 26;
    s = a[13] + (s >> 26);
    n += (s & 0x3ffffff) << 4;
    r[ 3] = Q6_R_and_RR(n, 0x3ffffff);
    n >>= 26;
    s = a[14] + (s >> 26);
    n += (s & 0x3ffffff) << 4;
    r[ 4] = Q6_R_and_RR(n, 0x3ffffff);
    n >>= 26;
    s = a[15] + (s >> 26);
    n += (s & 0x3ffffff) << 4;
    r[ 5] = Q6_R_and_RR(n, 0x3ffffff);
    n >>= 26;
    s = a[16] + (s >> 26);
    n += (s & 0x3ffffff) << 4;
    r[ 6] = Q6_R_and_RR(n, 0x3ffffff);
    n >>= 26;
    s = a[17] + (s >> 26);
    n += (s & 0x3ffffff) << 4;
    r[ 7] = Q6_R_and_RR(n, 0x3ffffff);
    n >>= 26;
    s = a[18] + (s >> 26);
    n += (s & 0x3ffffff) << 4;
    r[ 8] = Q6_R_and_RR(n, 0x3ffffff);
    n >>= 26;
    s = a[19] + (s >> 26);
    n += s << 4;
    r[ 9] = n;
