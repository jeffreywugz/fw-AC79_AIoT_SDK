...
#pragma bss_seg(".ble_mesh_healthcli_bss")
#pragma data_seg(".ble_mesh_healthcli_data")
#pragma const_seg(".ble_mesh_healthcli_const")
#pragma code_seg(".ble_mesh_healthcli_code")
#endif
...
#endif /* defined(CONFIG_BT_MESH_HEALTH_CLI) */
