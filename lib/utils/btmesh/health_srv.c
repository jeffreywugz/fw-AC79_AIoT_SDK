...
#pragma bss_seg(".ble_mesh_healthsrv_bss")
#pragma data_seg(".ble_mesh_healthsrv_data")
#pragma const_seg(".ble_mesh_healthsrv_const")
#pragma code_seg(".ble_mesh_healthsrv_code")
#endif
...
#endif /* defined(CONFIG_BT_MESH_HEALTH_SRV) */
